                ...
                <tr>
                  <td style="padding: 40px 30px;">
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="font-size: 15px; color: #444;">
                      ...
                      ${date ? `<tr>
                        <td style="padding: 10px 0; font-weight: bold;">Booking Date:</td>
                        <td style="padding: 10px 0;">${new Date(date).toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</td>
                      </tr>` : ''}
                      ${adults !== undefined ? `<tr>
                        <td style="padding: 10px 0; font-weight: bold;">Adults:</td>
                        <td style="padding: 10px 0;">${adults}</td>
                      </tr>` : ''}
                      ${children !== undefined ? `<tr>
                        <td style="padding: 10px 0; font-weight: bold;">Children:</td>
